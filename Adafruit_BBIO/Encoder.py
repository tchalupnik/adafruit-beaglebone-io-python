...
if not (int(major) >= 4 and int(minor) >= 4) and platform.node() == "beaglebone":
    raise ImportError(
...
class RotaryEncoder(object):
    ...
    def __init__(self, eqep_num):
        ...
        self._logger.debug("RotaryEncoder(): sys node: {0}".format(self._eqep.sys_path))
    ...
    def mode(self, mode):
        ...
        self._logger.debug("Mode set to: {}".format(self._eqep.node.mode))
    ...
    def position(self):
        ...
        self._logger.debug(
            "Get position: Channel {}, position: {}".format(
    ...
    def position(self, position):
        ...
        self._logger.debug(
            "Set position: Channel {}, position: {}".format(
                self._eqep.channel, position
            )
        )
    ...
    def frequency(self):
        ...
        self._logger.debug(
            "Set frequency(): Channel {}, frequency: {} Hz, period: {} ns".format(
                self._eqep.channel, frequency, self._eqep.node.period
            )
        )
